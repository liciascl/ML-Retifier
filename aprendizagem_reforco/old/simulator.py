...
filepath = pkg_resources.resource_filename("gym_simulator", path)
...
class BananaEnv(gym.Env):
    ...
    def __init__(self) -> None:
        ...
        logging.info(f"Env - Version {self.__version__}")
        ...
        self.curr_step = -1
        self.eficiency_max = False

        # Define what the agent can do
        # Eficiency in -20 -15 -10 -5 0 5 10 15 20 25 30 35 40 45 50 degrees
...
banana-gym/banana_env.py at master · MartinThoma/banana-gym · GitHub