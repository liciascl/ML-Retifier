...
class State:
	...
	def run(self):
		...
		while(self.n_simulation >= self.counter_simulation and done == False):
			...
			if done == False:
				agent.remember(self.RL, action, self.reward, self.RL_now, self.counter_simulation, int(done))
				agent.learn()
	...
	def choose_parameters(self):
		...
		action = agent.choose_action(self.RL)
